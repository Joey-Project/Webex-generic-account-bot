...
pub const LAUNCHER_MAX_CONNECTIONS: usize = 4;
...
pub const LAUNCHER_IO_TIMEOUT_SECONDS: u64 = 5;
pub const LAUNCHER_PREFLIGHT_RESPONSE_TIMEOUT_SECONDS: u64 = 10 * 60;
pub const INPUT_STAGING_TIMEOUT_SECONDS: u64 = 10 * 60;
pub const INPUT_STAGING_WORK_TIMEOUT_SECONDS: u64 = 9 * 60;
pub const INPUT_STAGING_PROCESS_TIMEOUT_SECONDS: u64 = 9 * 60 + 30;
pub const PENDING_WORKSPACE_CLEANUP_TIMEOUT_SECONDS: u64 = INPUT_STAGING_TIMEOUT_SECONDS;
pub const PENDING_WORKSPACE_CLEANUP_WORK_TIMEOUT_SECONDS: u64 = INPUT_STAGING_WORK_TIMEOUT_SECONDS;
pub const PENDING_WORKSPACE_CLEANUP_PROCESS_TIMEOUT_SECONDS: u64 =
    INPUT_STAGING_PROCESS_TIMEOUT_SECONDS;
pub const LAUNCHER_PREPARATION_WORK_TIMEOUT_SECONDS: u64 = 9 * 60;
pub const LAUNCHER_PREPARATION_PROCESS_TIMEOUT_SECONDS: u64 = 9 * 60 + 30;
pub const LAUNCHER_CANCELLATION_DRAIN_SECONDS: u64 = 105;
pub const LAUNCHER_EXECUTION_PREPARATION_GRACE_SECONDS: u64 = 10 * 60;
pub const LAUNCHER_CLEANUP_STEP_SECONDS: u64 = 10;
pub const LAUNCHER_TRANSIENT_CLEANUP_SECONDS: u64 = LAUNCHER_CLEANUP_STEP_SECONDS * 5;
pub const LAUNCHER_EXECUTION_CLEANUP_GRACE_SECONDS: u64 = 110;
pub const LAUNCHER_CLEANUP_PROCESS_TIMEOUT_SECONDS: u64 = 50;
pub const LAUNCHER_TRIGGER_LIMIT_BURST: usize = 32;
pub const LAUNCHER_EXECUTE_RESPONSE_OVERHEAD_SECONDS: u64 =
    LAUNCHER_EXECUTION_PREPARATION_GRACE_SECONDS
        + LAUNCHER_EXECUTION_CLEANUP_GRACE_SECONDS
        + LAUNCHER_IO_TIMEOUT_SECONDS;
pub const LAUNCHER_SERVICE_RUNTIME_MAX_SECONDS: u64 = 4_450;
const _: () = assert!(INPUT_STAGING_PROCESS_TIMEOUT_SECONDS > INPUT_STAGING_WORK_TIMEOUT_SECONDS);
const _: () = assert!(INPUT_STAGING_PROCESS_TIMEOUT_SECONDS < INPUT_STAGING_TIMEOUT_SECONDS);
const _: () = assert!(
    LAUNCHER_PREPARATION_PROCESS_TIMEOUT_SECONDS > LAUNCHER_PREPARATION_WORK_TIMEOUT_SECONDS
);
const _: () = assert!(
    LAUNCHER_PREPARATION_PROCESS_TIMEOUT_SECONDS < LAUNCHER_EXECUTION_PREPARATION_GRACE_SECONDS
);
const _: () = assert!(
    LAUNCHER_TRANSIENT_CLEANUP_SECONDS + LAUNCHER_CLEANUP_PROCESS_TIMEOUT_SECONDS
        < LAUNCHER_EXECUTION_CLEANUP_GRACE_SECONDS
);
const _: () = assert!(
    LAUNCHER_TRANSIENT_CLEANUP_SECONDS + LAUNCHER_CLEANUP_PROCESS_TIMEOUT_SECONDS
        < LAUNCHER_CANCELLATION_DRAIN_SECONDS
);
const _: () = assert!(LAUNCHER_TRIGGER_LIMIT_BURST >= LAUNCHER_MAX_CONNECTIONS * 8);
const _: () = assert!(
    LAUNCHER_SERVICE_RUNTIME_MAX_SECONDS
        > TIMEOUT_SECONDS_MAX
            + LAUNCHER_EXECUTE_RESPONSE_OVERHEAD_SECONDS
            + LAUNCHER_IO_TIMEOUT_SECONDS
            + LAUNCHER_CANCELLATION_DRAIN_SECONDS
);
pub const EPHEMERAL_RUNNER_WALL_OVERHEAD_SECONDS: u64 = LAUNCHER_IO_TIMEOUT_SECONDS * 2
    + LAUNCHER_PREFLIGHT_RESPONSE_TIMEOUT_SECONDS
    + INPUT_STAGING_TIMEOUT_SECONDS
    + PENDING_WORKSPACE_CLEANUP_TIMEOUT_SECONDS
    + LAUNCHER_IO_TIMEOUT_SECONDS * 2
    + LAUNCHER_EXECUTE_RESPONSE_OVERHEAD_SECONDS;
