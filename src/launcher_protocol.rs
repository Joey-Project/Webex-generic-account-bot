...
pub const LAUNCHER_CANCELLATION_DRAIN_SECONDS: u64 = 30;
pub const LAUNCHER_EXECUTION_PREPARATION_GRACE_SECONDS: u64 = 10 * 60;
pub const LAUNCHER_EXECUTION_CLEANUP_GRACE_SECONDS: u64 = 60;
pub const LAUNCHER_CLEANUP_PROCESS_TIMEOUT_SECONDS: u64 = 50;
pub const LAUNCHER_TRIGGER_LIMIT_BURST: usize = 10;
...
pub const LAUNCHER_SERVICE_RUNTIME_MAX_SECONDS: u64 = 4_300;
...
const _: () =
    assert!(LAUNCHER_CLEANUP_PROCESS_TIMEOUT_SECONDS < LAUNCHER_EXECUTION_CLEANUP_GRACE_SECONDS);
const _: () = assert!(LAUNCHER_TRIGGER_LIMIT_BURST >= LAUNCHER_MAX_CONNECTIONS * 2 + 2);
const _: () = assert!(
